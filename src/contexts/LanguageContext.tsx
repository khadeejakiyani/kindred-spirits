...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // Help - Entertainment Page
    "help.entertainment.title": "Entertainment Page",
    "help.entertainment.audio": "This is your Entertainment page where you can watch videos on YouTube. At the top, press the Watch Tutorial button for a step-by-step guide. Use the search box to find videos. Popular videos are shown below for easy access. You can save videos to watch later using the Save button, and see your watched history in the tabs at the bottom.",
    "help.entertainment.steps": "Press Watch Tutorial for a step-by-step guide|Type what you want to watch in the search box|Press the search button to find videos|Press any video card to watch it|Save videos using the Save button|Check your saved videos and history in the tabs",
    
    // Entertainment
    "nav.entertainment": "Watch",
    "entertainment.title": "Entertainment",
    "entertainment.subtitle": "Watch videos and relax",
    "entertainment.watchTutorial": "Watch Step-by-Step Tutorial",
    "entertainment.tutorialTitle": "How to Use YouTube",
    "entertainment.step": "Step",
    "entertainment.of": "of",
    "entertainment.previous": "Previous",
    "entertainment.next": "Next",
    "entertainment.done": "Done",
    "entertainment.skipTutorial": "Skip Tutorial",
    "entertainment.searchYoutube": "Search YouTube",
    "entertainment.searchPlaceholder": "Type what you want to watch...",
    "entertainment.popular": "Popular Videos",
    "entertainment.saved": "Saved",
    "entertainment.history": "History",
    "entertainment.noSaved": "No saved videos yet. Press the save button on any video!",
    "entertainment.noHistory": "No watched videos yet. Press any video to start!",
    "entertainment.saveVideo": "Save",
    "entertainment.relaxingNature": "Relaxing Nature Sounds",
    "entertainment.classicalMusic": "Beautiful Classical Music",
    "entertainment.gentleYoga": "Gentle Chair Yoga",
    "entertainment.oldSongs": "Classic Old Songs",
    "entertainment.tutorial.search.title": "How to Search",
    "entertainment.tutorial.search.desc": "Type what you want to watch in the search box. For example: 'old songs' or 'nature sounds'. Then press the red search button.",
    "entertainment.tutorial.watch.title": "How to Watch",
    "entertainment.tutorial.watch.desc": "Press on any video card to open it. The video will play in YouTube. Use the big play button in the center.",
    "entertainment.tutorial.save.title": "How to Save Videos",
    "entertainment.tutorial.save.desc": "Press the 'Save' button below any video to keep it for later. Your saved videos appear in the 'Saved' tab below.",
    "entertainment.tutorial.history.title": "Finding Watched Videos",
    "entertainment.tutorial.history.desc": "Every video you watch is remembered. Go to the 'History' tab at the bottom to see videos you've watched before.",
    "entertainment.tutorial.enjoy.title": "Enjoy Watching!",
    "entertainment.tutorial.enjoy.desc": "Take your time browsing. There's no rush. Watch relaxing nature videos, listen to old songs, or try gentle exercises.",
  ...
  ur: {
    ...
    // Help - Entertainment Page
    "help.entertainment.title": "تفریح کا صفحہ",
    "help.entertainment.audio": "یہ آپ کا تفریح کا صفحہ ہے جہاں آپ یوٹیوب پر ویڈیوز دیکھ سکتی ہیں۔ اوپر ٹیوٹوریل دیکھیں بٹن دبائیں قدم بہ قدم گائیڈ کے لیے۔ سرچ باکس استعمال کریں ویڈیوز تلاش کرنے کے لیے۔ مقبول ویڈیوز نیچے دکھائی دیتے ہیں۔ آپ ویڈیوز محفوظ کر سکتی ہیں بعد میں دیکھنے کے لیے، اور اپنی تاریخ نیچے ٹیبز میں دیکھ سکتی ہیں۔",
    "help.entertainment.steps": "قدم بہ قدم گائیڈ کے لیے ٹیوٹوریل دیکھیں دبائیں|سرچ باکس میں ٹائپ کریں جو دیکھنا چاہتی ہیں|ویڈیوز تلاش کرنے کے لیے سرچ بٹن دبائیں|کوئی ویڈیو کارڈ دبائیں دیکھنے کے لیے|محفوظ کریں بٹن سے ویڈیوز محفوظ کریں|محفوظ ویڈیوز اور تاریخ ٹیبز میں دیکھیں",
    
    // Entertainment
    "nav.entertainment": "دیکھیں",
    "entertainment.title": "تفریح",
    "entertainment.subtitle": "ویڈیوز دیکھیں اور آرام کریں",
    "entertainment.watchTutorial": "قدم بہ قدم ٹیوٹوریل دیکھیں",
    "entertainment.tutorialTitle": "یوٹیوب کیسے استعمال کریں",
    "entertainment.step": "قدم",
    "entertainment.of": "میں سے",
    "entertainment.previous": "پچھلا",
    "entertainment.next": "اگلا",
    "entertainment.done": "مکمل",
    "entertainment.skipTutorial": "ٹیوٹوریل چھوڑیں",
    "entertainment.searchYoutube": "یوٹیوب میں تلاش کریں",
    "entertainment.searchPlaceholder": "جو دیکھنا ہے لکھیں...",
    "entertainment.popular": "مقبول ویڈیوز",
    "entertainment.saved": "محفوظ",
    "entertainment.history": "تاریخ",
    "entertainment.noSaved": "ابھی کوئی محفوظ ویڈیو نہیں۔ کسی ویڈیو پر محفوظ بٹن دبائیں!",
    "entertainment.noHistory": "ابھی کوئی دیکھی ہوئی ویڈیو نہیں۔ شروع کرنے کے لیے کوئی ویڈیو دبائیں!",
    "entertainment.saveVideo": "محفوظ کریں",
    "entertainment.relaxingNature": "پرسکون قدرتی آوازیں",
    "entertainment.classicalMusic": "خوبصورت کلاسیکی موسیقی",
    "entertainment.gentleYoga": "ہلکی کرسی یوگا",
    "entertainment.oldSongs": "پرانے کلاسیکی گانے",
    "entertainment.tutorial.search.title": "تلاش کیسے کریں",
    "entertainment.tutorial.search.desc": "سرچ باکس میں لکھیں جو دیکھنا چاہتی ہیں۔ مثال کے طور پر: 'پرانے گانے' یا 'قدرتی آوازیں'۔ پھر سرخ سرچ بٹن دبائیں۔",
    "entertainment.tutorial.watch.title": "دیکھنا کیسے ہے",
    "entertainment.tutorial.watch.desc": "کوئی ویڈیو کارڈ دبائیں کھولنے کے لیے۔ ویڈیو یوٹیوب میں چلے گی۔ درمیان میں بڑا پلے بٹن استعمال کریں۔",
    "entertainment.tutorial.save.title": "ویڈیوز کیسے محفوظ کریں",
    "entertainment.tutorial.save.desc": "کسی ویڈیو کے نیچے 'محفوظ کریں' بٹن دبائیں بعد کے لیے رکھنے کو۔ محفوظ ویڈیوز نیچے 'محفوظ' ٹیب میں آتے ہیں۔",
    "entertainment.tutorial.history.title": "دیکھی ہوئی ویڈیوز تلاش کرنا",
    "entertainment.tutorial.history.desc": "ہر ویڈیو جو آپ دیکھتی ہیں یاد رہتی ہے۔ نیچے 'تاریخ' ٹیب میں جائیں پہلے دیکھی ہوئی ویڈیوز کے لیے۔",
    "entertainment.tutorial.enjoy.title": "لطف اٹھائیں!",
    "entertainment.tutorial.enjoy.desc": "آرام سے براؤز کریں۔ کوئی جلدی نہیں۔ پرسکون قدرتی ویڈیوز دیکھیں، پرانے گانے سنیں، یا ہلکی ورزشیں آزمائیں۔",
